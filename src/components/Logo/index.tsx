import { SVGProps, FC, useRef, RefObject } from 'react';
...
export const SvgLogo: FC<MySvgProps> = ({ ...props }) => {
  ...
  return (
    <Svg
      ...
      viewBox="56.46 12.86 387.08 124.28"
      ref={svgRef}
      {...props}
    >
      <defs>
        <linearGradient id="a" x1={0.765} x2={0.235} y1={0.924} y2={0.076} gradientUnits="objectBoundingBox">
          <stop offset={0} stopColor="#ffb800" />
          <stop offset={1} stopColor="#ce00ff" />
        </linearGradient>
      </defs>
      <path
        fill="url(#a)"
